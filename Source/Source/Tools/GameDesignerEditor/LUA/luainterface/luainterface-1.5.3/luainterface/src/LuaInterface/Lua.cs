...
namespace LuaInterface 
{
	...
	public class Lua : IDisposable
	{
        ...
        List<LuaFunction> luaFunctions = new List<LuaFunction>();
        ...
        public void addLuaTable(LuaTable table)
        {
            luaTables.Add(table);
        }

        public void addLuaFunction(LuaFunction func)
        {
...
//             if (!(obj is LuaCSFunction) && !(obj is LuaFunction))
//             {
//                 return null;
//             }
